...
var AppComponent = /** @class */ (function () {
    function AppComponent(formBuilder, cardsService) {
        this.formBuilder = formBuilder;
        this.cardsService = cardsService;
        this.title = 'Bingo Meetings';
        this.meetings = [];
        // why this gives an compilation error if we put new CreateMeeting ? references?
        var c = { userName: '', meetingName: '' };
        this.createMeetingForm = this.formBuilder.group(c);
    }
    AppComponent.prototype.ngOnInit = function () {
        this.refreshMeetings();
    };
    AppComponent.prototype.refreshMeetings = function () {
        var _this = this;
        this.cardsService.GetMeetings().subscribe(function (it) { return _this.meetings = it; });
    };
    AppComponent.prototype.onSubmit = function (data) {
        var _this = this;
        this.createMeetingForm.disable();
        this.cardsService.SaveMeeting(data).subscribe(function (it) {
            _this.createMeetingForm.enable();
            _this.createMeetingForm.reset();
            _this.refreshMeetings();
        });
    };
...
var CardsService = /** @class */ (function () {
    ...
    CardsService.prototype.GetMeetings = function () {
        var url = this.urlApi + 'meetings';
        return this.httpAPI.get(url);
    };
    CardsService.prototype.SaveMeeting = function (create) {
        var url = this.urlApi + 'meetings';
...
var MeetingRunningComponent = /** @class */ (function () {
    function MeetingRunningComponent(route, cardService) {
        this.route = route;
        this.cardService = cardService;
        this.actualMeeting = null;
    }
    MeetingRunningComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.subscribe(function (params) {
            _this.id = params.get('id');
            _this.cardService.GetMeeting(_this.id).subscribe(function (w) {
                _this.actualMeeting = new bingo_meeting_objects__WEBPACK_IMPORTED_MODULE_3__["Meeting"](w);
                // window.alert(this.actualMeeting.Name);
                // window.alert(this.actualMeeting.Creator());
            });
        });
    };
    MeetingRunningComponent.ctorParameters = function () { return [
    ...
    return MeetingRunningComponent;
}());
